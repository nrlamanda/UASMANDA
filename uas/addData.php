...
<body style="background-color: #FFA500;">
          ...
          <div class="row my-2 text-light">
               <div class="col-md">
                    <form action="" method="post" enctype="multipart/form-data">
                         <div class="mb-3">
                              <label for="nis" class="form-label">Nomor</label>
                              <input type="number" class="form-control w-50" id="nis" placeholder="Masukkan Nomor" min="1"
     ...
     <div class="container-fluid">
          <div class="row bg-dark text-white text-center">
               <div class="col my-2" id="about">
                    ...
                    <p>
                    ini adalah sistem yang di rancang untuk memudahkan pegawai dalam mendata pasien . by nurul amanda
                    </p>
               </div>
          </div>
     </div>
     ...
     gsap.to('.Tambah_data', {
          duration: 2,
          delay: 1,
          text: '<i class="bi bi-person-plus-fill"></i>Tambah Data pasien :)'
     })
     gsap.from('.navbar', {
          duration: 1,
          y: '-100%',

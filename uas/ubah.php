...
<body style="background-color: #FFA500;">
          ...
          <div class="row my-2 text-light">
               <div class="col-md">
                    <form action="" method="post" enctype="multipart/form-data">
                         ...
                         <div class="mb-3">
                              <label for="jurusan" class="form-label">penyakit</label>
                              <select class="form-select w-50" id="jurusan" name="jurusan">
                                   <option disabled selected value>--------------------------------------------Pilih
                                        pilih penyakit--------------------------------------------</option>
                                   <option value="jantung" <?php if ($siswa['jurusan'] == 'jantung') { ?>
                                        selected='' <?php } ?>>jantung</option>
                                   <option value="hati"
                                        <?php if ($siswa['jurusan'] == 'hati') { ?> selected=''
                                        <?php } ?>>hati</option>
                                   <option value="lambung" <?php if ($siswa['jurusan'] == 'lambung') { ?>
                                        selected='' <?php } ?>>lambung</option>
                                   <option value="diabetes"
                                        <?php if ($siswa['jurusan'] == 'diabetes') { ?> selected=''
                                        <?php } ?>>diabetes</option>
                                   <option value="demam" <?php if ($siswa['jurusan'] == 'demam') { ?>
                                        selected='' <?php } ?>>demam</option>
                                   <option value="pusing" <?php if ($siswa['jurusan'] == 'pusing') { ?> selected=''
                                        <?php } ?>>pusing</option>
                              </select>
                         </div>
                         <div class="mb-3">
     ...
     <div class="container-fluid">
          <div class="row bg-dark text-white text-center">
               <div class="col my-2" id="about">
                    ...
                    <p>
                         ini adalah sistem yang di rancang untuk memudahkan pegawai dalam mendata pasien . by nurul amanda 2109010081
                    </p>
               </div>
          </div>
     </div>
     ...
     gsap.to('.ubah_data', {
          duration: 2,
          delay: 1,
          text: '<i class="bi bi-pencil-square"></i>Ubah Data pasien'
     })
     gsap.from('.navbar', {
          duration: 1,
          y: '-100%',
